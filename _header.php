        ...
        <div class="downer-header-right">
            ...
            if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true) {
                ...
                echo '<a href="cart.php" class="cart-link">';
                        ...
                        $get_cart_item_sql = "SELECT * FROM `cart` WHERE `customer_id`='$customer_id'";
                        $get_cart_item_res = mysqli_query($conn, $get_cart_item_sql);
                        $get_cart_item_rows = mysqli_num_rows($get_cart_item_res);

                        if ($get_cart_item_rows > 0) {
                            echo '<span class="number-of-ordered-items">'.$get_cart_item_rows.'</span>';
                        }

                        echo '<ion-icon class="ionicon cart-icon" name="cart-outline"></ion-icon>
                    </a>
                <div class="account">
                    ...
                    <ul class="account-action-list" id="account-action-list">
                        <li><a href="account/my_profile.php">My Profile</a></li>
                ...
                echo '<a href="account/login.php" class="user-link"><i class="fa-regular fa-user"></i></a>';
            }
        ...
        <div class="links">
            <ul>
                ...
                if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true) {
                    ...
                    echo '<li><a href="account/login.php" class="login-anchor">Login</a></li>
